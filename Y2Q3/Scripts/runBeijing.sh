...
spark-submit ~/PhD/Y2Q3/PFlock/target/scala-2.11/pflock_2.11-1.0.jar --prefix /home/acald013/Datasets/Beijing/P --master spark://169.235.27.134:7077 --cores $CORES --output test

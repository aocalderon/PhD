...
\title[Spark + Simba]{Spark + Simba: Efficient In-Memory Spatial Analytics.}
\subtitle{Based on Dong Xie, Feifei Li, Bin Yao, Gefei Li, Liang Zhou and Minyi Guo \\ \small SIGMOD'16.}
...
\begin{frame}[noframenumbering]{Simba Architecture}
  ...
  \begin{minipage}{.75\linewidth} 
    ...
    \end{tikzpicture}
  \end{minipage}
  \begin{minipage}{.21\linewidth} \tiny \color{blue} Indexing \\ \color{red} Spatial operations  \\ \color{white} Optimizations \\ Programming interface \end{minipage}  
\end{frame}
...
\begin{frame}[noframenumbering]{Simba Architecture}
  ...
  \begin{minipage}{.75\linewidth} 
    ...
    \end{tikzpicture}
  \end{minipage}
  \begin{minipage}{.21\linewidth} \tiny \color{blue} Indexing \\ \color{red} Spatial operations \\ \color{magenta} Optimizations \\ \color{white} Programming interface \end{minipage}  
\end{frame}
...
\begin{frame}[noframenumbering]{Simba Architecture}
  ...
  \begin{minipage}{.75\linewidth} 
    ...
    \end{tikzpicture}
  \end{minipage}
  \begin{minipage}{.21\linewidth} \tiny \color{blue}Indexing \\ \color{red} Spatial operations \\ \color{magenta} Optimizations \\ \color{olive} Programming interface \end{minipage}  
\end{frame}
...
\begin{frame}{Two-level indexing strategy}
  \centering 
  \includegraphics[page=6,clip,trim=2cm 21.9cm 11.5cm 2.2cm,width=\textwidth]{simba_paper}
\end{frame}
...
\begin{frame}{Partition estimation}
	\begin{itemize}
		...
		\begin{itemize}
			\item Use of a sampling based approach to build estimators.
		\end{itemize}
...
\begin{frame}[noframenumbering]{Comparison with existing systems}
  \centering

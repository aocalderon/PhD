package main.scala.SPMF;/* This file is copyright (c) 2008-2015 Philippe Fournier-Viger
* 
...
/**
 * This is an implementation of a SPMF.MFITree as used by the FPMax algorithm.
 *
...
public class MFITree {
    ...
    private Map<Integer, MFINode> mapItemNodes = new HashMap<>();

    // Map that indicates the last node for each item using the node links
    // key: item   value: an fp tree node
    private Map<Integer, MFINode> mapItemLastNode = new HashMap<>();
     ...
     */
    void addMFI(int[] itemset, int itemsetLength) {
...
//		currentNode.counter = support;
     ...
     */
    boolean passSubsetChecking(List<Integer> headWithP) {
        ...
        // the itemset is not in the MFI-TREE.  SPMF.Itemset passed the test!
        return true;
    }

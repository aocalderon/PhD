...
table = xtable(table, caption = "Comparing the four versions of the Sieve of Erastosthenes.", label = "tab:table2", align="cccccc")
addtorow <- list()
addtorow$pos <- list(0)
...
print(table, include.rownames=F, add.to.row = addtorow, booktabs = T, include.colnames=F, file="tbl_table2.tex")
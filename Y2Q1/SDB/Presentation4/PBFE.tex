...
\begin{frame}{Beijing [N = 10K - 100K; $\varepsilon$ = 10 - 200 (mts)]}
  \centering
  \includegraphics[width=0.88\textwidth]{Figures/results/Beijing10K-100K_E10-200}
  \blfootnote{\url{http://tinyurl.com/js6us8g}}
\end{frame}
...
\begin{frame}{Porto [N = 1M - 16M; $\varepsilon$ = 2 - 10 (mts)]}
  \centering
  \includegraphics[width=0.88\textwidth]{Figures/results/Porto_PBFE_N1M-16M_E2-10}
  \blfootnote{\url{http://tinyurl.com/j9u9c7h}}
\end{frame}

...
\begin{frame}{Finding the disks...}
  \centering
  \animategraphics[autoplay, loop,width=0.85\textheight]{2}{Figures/n/c-}{0}{9}
\end{frame}

\section{Proposal (a.k.a. The Solution)}

\begin{frame}{Can be done in parallel?}
  \begin{minipage}{.7\linewidth} \includegraphics[page=1,height=0.9\linewidth]{Figures/d} \end{minipage}
  \begin{minipage}{.10\linewidth} Partition \\ Local \\ Pruning \\ Global \end{minipage}
\end{frame}
\begin{frame}{Can be done in parallel?}
  \begin{minipage}{.7\linewidth} \includegraphics[page=2,height=0.9\linewidth]{Figures/d} \end{minipage}
  \begin{minipage}{.10\linewidth} \textbf{Partition} \\ Local \\ Pruning \\ Global \end{minipage}
\end{frame}
\begin{frame}{Can be done in parallel?}
  \begin{minipage}{.7\linewidth} \includegraphics[page=3,height=0.9\linewidth]{Figures/d} \end{minipage}
  \begin{minipage}{.10\linewidth} Partition \\ \textbf{Local} \\ Pruning \\ Global \end{minipage}
\end{frame}
\begin{frame}{Can be done in parallel?}
  \begin{minipage}{.7\linewidth} \includegraphics[page=4,height=0.9\linewidth]{Figures/d} \end{minipage}
  \begin{minipage}{.10\linewidth} Partition \\ \textbf{Local} \\ Pruning \\ Global \end{minipage}
\end{frame}
\begin{frame}{Can be done in parallel?}
  \begin{minipage}{.7\linewidth} \includegraphics[page=5,height=0.9\linewidth]{Figures/d} \end{minipage}
  \begin{minipage}{.10\linewidth} Partition \\ Local \\ \textbf{Pruning} \\ Global \end{minipage}
\end{frame}
\begin{frame}{Can be done in parallel?}
  \begin{minipage}{.7\linewidth} \includegraphics[page=6,height=0.9\linewidth]{Figures/d} \end{minipage}
  \begin{minipage}{.10\linewidth} Partition \\ Local \\ Pruning \\ \textbf{Global} \end{minipage}
\end{frame}
\begin{frame}{Can be done in parallel?}
  \begin{minipage}{.7\linewidth} \includegraphics[page=7,height=0.9\linewidth]{Figures/d} \end{minipage}
  \begin{minipage}{.10\linewidth} Partition \\ Local \\ Pruning \\ \textbf{Global} \end{minipage}
\end{frame}

\begin{frame}{In Memory MapReduce Analytics}
  \centering \includegraphics[width=0.4\textwidth]{Figures/logo.png}
  \begin{itemize}
...
\begin{frame}{In Memory MapReduce Analytics}
  ...
  \includegraphics[page=6,clip,trim=2cm 21.5cm 11.5cm 2.2cm,height=0.5\textheight]{Figures/simba}
    \\ \vspace{0.5cm} \flushright \tiny (Xie et al, 2016)
\end{frame}

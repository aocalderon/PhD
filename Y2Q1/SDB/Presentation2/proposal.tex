...
\begin{frame}{Applications}
  \begin{itemize}
    \item Integrated transportation systems...
  \end{itemize}
  \centering
...
\begin{frame}{Applications}
  \begin{itemize}
    \item Tropical cyclones path similarity...
  \end{itemize}
  \centering
...
%   \end{itemize}
%   \centering
%   \animategraphics[autoplay, loop,width=.7\textheight]{5}{Figures/birds1/frame-}{0}{13}
%   %\\ \vspace{1cm} \tiny source
% \end{frame}
...
\begin{frame}{Finding maximal disks...}
  \centering
  \includegraphics[height=0.55\paperwidth]{Figures/test}
\end{frame}

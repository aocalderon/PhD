...
\begin{frame}{PFlock implementation}
    \begin{itemize}
      \item Re-written in Scala using Simba library over Spark 2.1.0.
      \item Code available at \\ \scriptsize \url{https://github.com/aocalderon/PhD/tree/master/Y2Q3/PFlock}.
    \end{itemize}
\end{frame}
...
\begin{frame}{Setup}
  \begin{itemize}
    \item 3-node cluster at DBLab.
    \item Processors: 8-core Intel(R) Xeon(R) CPU E3-1230 V2 @ 3.30GHz
    \item RAM: 15.5 GB.
    \item Centos 6.8, Simba/Spark 2.1.0.
  \end{itemize}
\end{frame}

...
\begin{frame}[fragile]{Python scripts}
  \tiny
  \lstinputlisting[language=Python]{../getUrls.py}
\end{frame}

\begin{frame}[fragile]{Python scripts}
  \tiny
  \lstinputlisting[language=Python]{../getUrlInfo.py}
\end{frame}
...
\begin{frame}[fragile]{Python script}
  \tiny
  \lstinputlisting[language=Python]{../getPingInfo.py}
\end{frame}
...
\begin{frame}[fragile]{Python script}
  \tiny
  \lstinputlisting[language=Python]{createGraph.py}
\end{frame}

...
data <- readLines(paste0("Results/results",app_prefix,fea_prefix,"NT.txt")) 
...
data <- readLines(paste0("Results/results",app_prefix,fea_prefix,"T.txt")) 
data <- data[start:length(data) - 1]
results$C2 <- empty
for(i in 1:n){
  result <- strsplit(strsplit(data[i], "#")[[1]][1], "\\s+")[[1]]
...
data <- readLines(paste0("Results/results",app_prefix,fea_prefix,"BM.txt")) 
data <- data[start:length(data) - 1]
results$C4 <- empty
for(i in 1:n){
  result <- strsplit(strsplit(data[i], "#")[[1]][1], "\\s+")[[1]]
...
data <- readLines(paste0("Results/results",app_prefix,fea_prefix,"2L.txt")) 
data <- data[start:length(data) - 1]
results$C8 <- empty
results$desc <- empty
for(i in 1:n){

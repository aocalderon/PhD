...
data <- readLines("Results/results_I2.txt") 
data <- data[start:length(data) - 1]
results$C2 <- empty
for(i in 1:n){
  result <- strsplit(strsplit(data[i], "#")[[1]][1], "\\s+")[[1]]
...
data <- readLines("Results/results_I4.txt") 
data <- data[start:length(data) - 1]
results$C4 <- empty
for(i in 1:n){
  result <- strsplit(strsplit(data[i], "#")[[1]][1], "\\s+")[[1]]
...
data <- readLines("Results/results_I8.txt") 
data <- data[start:length(data) - 1]
results$C8 <- empty
results$desc <- empty
for(i in 1:n){
...
write.csv(results,'Results/metrics_I.csv',row.names = F)

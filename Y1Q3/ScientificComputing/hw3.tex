...
\\
(a) 
%The singular values are almost ready, we only have to deal with the negative sign in position $(2,2)$ through:
$$\left( \begin{array}{cc} 3 & 0 \\ 0 & -2  \end{array} \right) = 
\left( \begin{array}{cc} 1 & 0 \\ 0 & 1  \end{array} \right)
\left( \begin{array}{cc} 3 & 0 \\ 0 & 2  \end{array} \right)
\left( \begin{array}{cc} 1 & 0 \\ 0 & -1  \end{array} \right)$$
(b) 
%Here, we only have to deal with the order of the singular values:

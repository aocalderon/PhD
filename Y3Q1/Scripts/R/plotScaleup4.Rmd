...
### Experiments using spatial sampling (mu=12).
...
temp_title = paste("(radius of disk in mts) in Berlin dataset (spatial sampling).")
...
### Number of candidate and maximal disks (mu=12).

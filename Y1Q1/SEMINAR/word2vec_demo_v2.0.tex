...
\begin{frame}{word2vec source code}
  \centering
  \includegraphics[width=0.65\textwidth]{./Figures/00-svn.png}
\end{frame}
...
\begin{frame}{3d plot}
  \centering
  \includegraphics[width=\textwidth]{./Figures/14-3d.png}
\end{frame}
...
\begin{frame}{Parcoord plot}
  \centering
  \includegraphics[width=\textwidth]{./Figures/15-parcoord.png}
\end{frame}
...
\begin{frame}{From words to phrases and beyond}
  \begin{itemize}
    \item It is desirable to have only one vector for representing `los\_angeles'.
...
\begin{frame}[fragile]{demo-phrases.sh output}
  \inputminted[
    fontsize=\tiny,
    tabsize=2,
    breaklines,
...
\begin{frame}{demo-phrases.sh}
  \centering
  \includegraphics[width=0.6\textwidth]{./Figures/16-phrases.png}
\end{frame}

\begin{frame}{demo-phrases.sh}
  \centering
  \includegraphics[width=0.6\textwidth]{./Figures/17-phrases.png}
\end{frame}
...
\begin{frame}{}
  ...
  \huge Thank you!!! \\
  \vspace{2cm}
  \tiny Download this presentation at \url{https://goo.gl/WvZrMP}
\end{frame}
...
\begin{frame}{Ports of the framework...}
  \begin{itemize}

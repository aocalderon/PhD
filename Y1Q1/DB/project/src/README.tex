...
\vspace{\baselineskip}
\noindent The four jobs take around 01m21s to complete\footnote{See details at \url{http://www.cs.ucr.edu/~acald013/MP_Output.txt}.}.
...
\subsection{Appendix}
The bash script in figure \ref{fig:compile} has some instructions to compile and run the jobs.  It is submitted together with DataReducer.java and DataReducer.jar files which are the source code and executable of my implementation.
...
\caption{Bash script for compilation and execution.}\label{fig:compile}
\end{figure}
